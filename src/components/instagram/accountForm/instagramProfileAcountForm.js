...
const AccountForm = ({ initialData = {}, onSubmit, isEdit = false, loading = false }) => {
  ...
  useEffect(() => {
    if (!isInitialized && Object.keys(initialData).length > 0) {
      setFormData({
        id: initialData.id || 0,
        facebookPageId : initialData.facebookPageId || 0,
        instagramAppId: initialData.instagramAppId || '',
  ...
  const validateForm = () => {
    ...
    if (!formData.instagramAppId) newErrors.instagramAppId = 'instagram Id gerekli';
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={handleChange}
                error={!!errors.instagramAppId}
                helperText={errors.instagramAppId}
                required
                variant="outlined"
                InputLabelProps={{ shrink: true }}
              />
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                helperText={errors.facebookPageId}
                required
                variant="outlined"
                InputLabelProps={{ shrink: true }}
              />
