...
const FacebookAccountListForInstagram = () => {
      ...
      >
        ...
        <TableCell align="right">
          <Tooltip title="Hesabı Düzenle">
            <IconButton
              color="primary"
              onClick={() => navigate(`/instagram-accounts/edit/${account.companyId}`)}
            >
              <Edit />
            </IconButton>
          </Tooltip>
      ...
      >
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
          <Button
            ...
            color="primary"
            startIcon={<Edit />}
            onClick={() => navigate('/instagram-accounts/create')}
...
export default FacebookAccountListForInstagram;