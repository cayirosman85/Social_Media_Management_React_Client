...
const InstagramMessengerAccountList = () => {
  ...
  const fetchAccounts = useCallback(async () => {
    setLoading(true);
    try {
      const data = await apiFetch('/api/InstagramMessengerAccount');
  ...
  const handleDelete = useCallback(
    async (companyId) => {
      ...
      try {
        await apiFetch(`/api/InstagramMessengerAccount/${companyId}`, { method: 'DELETE' });
...
export default InstagramMessengerAccountList;